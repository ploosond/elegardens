...
# Pinned to match "packageManager" in package.json so rebuilds stay reproducible
...
# allowBuilds approvals - without this the runtime install skips sharp's native binary
