      ...
      <div className="mx-auto mt-8 px-4 sm:mt-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-24">
          <div className="flex flex-col items-start">
            ...
            <div className="flex w-full flex-col items-center gap-4">
              <div className="relative aspect-[2/3] w-full max-h-[480px] overflow-hidden rounded-lg bg-muted">
                <Image src={imageUrl} alt={altText} fill className="object-cover" priority />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <p className="text-justify leading-relaxed text-text">{productDesc}</p>
          </div>
        </div>
      </div>
          ...
          <div className="mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-8 flex items-end justify-between">
              <div>
                ...
                <p className="mt-2 text-lg text-gray-600">{t('you_might_also_like')}</p>
              </div>
              <Link
                href={`/${locale}/products`}
