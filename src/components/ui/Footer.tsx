        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2">
              ...
              <li>
                <Link href="/teams" className=" transition-colors hover:text-accent">
                  {t('teams')}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/career" className=" transition-colors hover:text-accent">
                  {t('careers')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              <a href="#" className="p-2 transition-colors hover:text-accent" aria-label="Facebook">
                <FaFacebookF size={20} />
              </a>
              <a href="#" className="p-2 transition-colors hover:text-accent" aria-label="Twitter">
                <FaXTwitter size={20} />
              </a>
              <a
                href="#"
